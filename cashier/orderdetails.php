...
<head>
  ...
  <title>Order Details - BrewEase Cashier</title>
...
<div class="max-w-3xl mx-auto p-6">
    <header class="mb-6">
        ...
        <a href="orders.php" class="text-white hover:text-white">&larr; Back to Orders</a>
    </header>

    <section class="mb-8 bg-white rounded-2xl shadow p-6">
        <h2 class="text-xl font-semibold text-[#207B52] mb-4">Order Information</h2>
    ...
    <section class="bg-white rounded-2xl shadow p-6">
        <h2 class="text-xl font-semibold text-[#207B52] mb-4">Items</h2>
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200 text-sm">
                ...
                <tbody class="divide-y divide-gray-200 bg-white">
                    ...
                    ?>
                    <tr>
                        <td class="px-6 py-4 text-gray-700"><?= htmlspecialchars($item['product_name']) ?></td>
                        <td class="px-6 py-4 text-gray-700"><?= htmlspecialchars($item['addon'] ?? '-') ?></td>
                        <td class="px-6 py-4 text-right text-gray-700"><?= intval($item['quantity']) ?></td>
